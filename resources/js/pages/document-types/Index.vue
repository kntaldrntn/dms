        ...
        <div class="flex flex-col gap-6 p-6 w-full mx-auto bg-slate-100 min-h-screen">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm text-slate-700">
                        ...
                        <thead class="bg-slate-100 text-xs text-slate-600 uppercase tracking-wider border-b border-slate-200">
                            <tr>
                                ...
                                <th class="px-4 py-2.5 font-bold">Document Type</th>
                                <th class="px-4 py-2.5 font-bold">Code</th>
                        ...
                        <tbody class="divide-y divide-slate-200">
                            ...
                            <tr v-for="docType in documenttypes.data" :key="docType.id" class="transition-colors hover:bg-slate-50" :class="{'opacity-75 bg-slate-50': docType.state === 0}">
                                <td class="px-4 py-2 font-mono text-sm text-slate-500">{{ docType.id }}</td>
                                <td class="px-4 py-2 font-medium text-slate-800">{{ docType.document_type }}</td>
                                <td class="px-4 py-2">
                                ...
                                <!-- Status Column -->
                                <td class="px-4 py-2">
                                    <span v-if="docType.state === 1" class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-emerald-50 text-emerald-700 border border-emerald-100">
                    ...
                    <!-- Empty State -->
                    <div v-if="documenttypes.data.length === 0" class="py-12 text-center">
                ...
                <div v-if="documenttypes.last_page > 1" class="flex items-center justify-between border-t border-slate-200 bg-slate-50 px-4 py-3">
                        ...
                        <form @submit.prevent="submitForm" class="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g. PR"
                                />
                                <p v-if="form.errors.document_code" class="mt-1 text-xs text-red-500">{{ form.errors.document_code }}</p>
                            </div>
